...
1. **Load rubric** — read [scoring.md](../skills/ru-text/references/scoring.md) for the full rubric with anchors.

2. **Determine domain** — identify whether the text is UI/interface, business email, article, or general:
   - UI text → also load [ux-writing.md](../skills/ru-text/references/ux-writing.md) for the Reader Precision dimension
   - Business email → also load [business-writing.md](../skills/ru-text/references/business-writing.md) for the Reader Precision dimension
   - General → use [info-style.md](../skills/ru-text/references/info-style.md) only

3. **Evaluate each dimension separately** — score in this order:
   - **T — Типографика** (weight 0.15): quotes, dashes, spaces, special characters per [typography.md](../skills/ru-text/references/typography.md)
   - **Ч — Чистота языка** (weight 0.25): stop-words, bureaucratic language, clichés, passive voice per [info-style.md](../skills/ru-text/references/info-style.md) + [anti-patterns.md](../skills/ru-text/references/anti-patterns.md)
   - **Г — Грамотность** (weight 0.20): punctuation, agreement, tautology per [editorial-grammar.md](../skills/ru-text/references/editorial-grammar.md) + [editorial-punctuation.md](../skills/ru-text/references/editorial-punctuation.md)
   - **С — Структура** (weight 0.20): logical flow, paragraphs, transitions, heading use per [info-style.md](../skills/ru-text/references/info-style.md) structure section + [addenda.md](../skills/ru-text/references/addenda.md)
