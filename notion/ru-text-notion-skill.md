...
*ru-text — independently formulated rules for Russian text quality. Full version (2,000+ atoms, 7 domains): [github.com/talkstream/ru-text](https://github.com/talkstream/ru-text). Author: Arseniy Kamyshev. License: MIT.*
