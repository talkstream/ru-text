...
**Плагин для Claude Code, Codex CLI, Gemini CLI и Cursor — качество русского текста** — типографика, информационный стиль, редактура, UX-тексты и деловая переписка.

~1040 авторских правил, основанных на изучении 16 канонических русскоязычных источников. Все формулировки оригинальные — без дословного цитирования, с полной атрибуцией.
...
Работает с Claude Code, Codex CLI, Gemini CLI и Cursor.

- **~1040 правил** в 7 доменах, упакованных в 9 справочных файлов + дополнения
...
Доступен в официальном [маркетплейсе плагинов Anthropic](https://claude.com/plugins). Работает в Claude Code CLI, VS Code, JetBrains, Web и Desktop.
...
- SKILL.md: 600 слов, 94 строки (рекомендация: до 2 000 слов, до 500 строк)
