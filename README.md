...
ru-text — навык вычитки русского текста для ИИ-агентов. Он работает внутри агента и чистит это по ходу дела: типографику, канцелярит и семнадцать примет машинного текста (нейрослоп). На каждую правку даёт цитату и правило, по которому она сделана.
