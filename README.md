...
Релиз про то, что инструмент **перестал** править.

- **Капслок в одно-два слова остаётся.** `СРОЧНО: сервер лежит` — намеренная эмоция, а не небрежность. Замечание теперь только на полосе из трёх и более прописных слов подряд.
- **Усилители при признании вины, обещании и извинении остаются.** «Мы действительно сорвали срок» — не находка: удаляя это слово, правишь не стиль, а социальный жест. «Оборудование у нас действительно современное» находкой осталось.
- **Ещё четыре оговорки:** пассив о поведении продукта, приблизительные числа словами, англицизмы, даты в таблицах.
- **Точнее ловятся** объявленная искренность и запятая, сомкнутая с тире.

Эталонный набор вырос с 28 текстов до 31: у каждой оговорки теперь есть текст, где она обязана сработать. [Что изменилось](CHANGELOG.md) · [Релиз](https://github.com/talkstream/ru-text/releases/tag/v2.1.0)
