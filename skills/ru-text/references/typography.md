...
> Регистр и приоритет: ru-text ориентирован на общий и веб-текст, поэтому опирается прежде всего на человеко-ориентированные справочники по типографике и редактуре -- «Ководство» А. Лебедева, «Справочник издателя и автора» Мильчина и Чельцовой, справочники Розенталя. Где такой справочник даёт норму для общего и веб-текста, она имеет приоритет. Метрологический стандарт (ГОСТ 8.417-2024) применяется только там, где эти справочники вопрос не покрывают, либо как контекстный вариант для научно-технических документов. Ниже это затрагивает знак процента (R37); провенанс слитного написания остаётся за Шульмейстером и Гиленсоном и де-факто нормой Рунета, без привязки к конкретным параграфам «Ководства».
